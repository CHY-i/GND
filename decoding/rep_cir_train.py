...
if __name__ == '__main__':
    ...
    if cotrain == False:
        ...
        print(ni)
        van = MADE(n=ni, depth=5, width=25, residual=False).to(device).to(dtype)
        ...
        for l in range(epoch):
            ...
            dets, obvs = sampler.sample(shots=trials, separate_observables=True)
        ...
        path = abspath(dirname(__file__))+'/net/cir/'+'rep_sim_d{}_r{}_k{}_er{}.pt'.format(d, r, k, er)
        torch.save(van, path)
